...
// import { Ship, Waves, Anchor, Compass, Mail, Lock, LogIn } from "lucide-react";
...
//       navigate("/dashboard");
//     } catch (error) {
//       setError(error.message || "Failed to log in. Check your email and password.");
...
//     } catch (error) {
//       setError(error.message || "Failed to reset password. Check your email address.");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//             Chart your course to better habits
//           </p>
//         </div>
...
//           <div className='bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 max-w-md w-full border border-cyan-500/20'>
...
//                 className='w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent dark:bg-gray-700 dark:text-white mb-4'
//                 disabled={loading}
//               />
...
//                   type='submit'
//                   disabled={loading}
//                   className='flex-1 py-2 px-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white rounded-lg disabled:opacity-50 flex items-center justify-center'
//                 >
//                   {loading ? (
